...
def register_dashboard_routes(app):
    ...
    has_auth = hasattr(app, 'view_functions') and 'login' in app.view_functions
    
    if not has_auth:
        # Provide a simplified dashboard without auth requirements
        @app.route('/dashboard')
        ...
        def dashboard():
            ...
            recent_activity = [
                {
                    'title': 'Welcome!',
                    'description': 'Dashboard loaded successfully (no auth required)',
                    'timestamp': 'Just now',
                    'type': 'system'
                }
            ]
        ...
        # Full dashboard with optional authentication
        @app.route('/dashboard')
        @app.route('/')  # Make dashboard the home page too
        def dashboard():
